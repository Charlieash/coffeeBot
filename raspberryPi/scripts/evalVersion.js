...
var coffees = ["americano", "latte", "flat_white", "espresso", "hot_water","test"];
...
demo.addEventListener("click", function () { demo.innerHTML = '<? php writeOrderId() ?>'; if (coffee != null /*&& milk != null*/) { result = createString(coffee, milk) };stored = stored.concat(result); sendData(stored) ;location.reload(); });
